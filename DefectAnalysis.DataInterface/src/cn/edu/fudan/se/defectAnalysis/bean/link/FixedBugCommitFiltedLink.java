...
public class FixedBugCommitFiltedLink implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FixedBugCommitFiltedLink)) {
			return false;
		}
		FixedBugCommitFiltedLink other = (FixedBugCommitFiltedLink) obj;
	...
	public String toString() {
		return "FixedBugCommitFiltedLink [revisionId=" + revisionId
				+ ", bugId=" + bugId + "]";
	}
}
