...
public abstract class FileDiff implements Comparable<FileDiff> {
	 ...
	 * 
	 * @param type
	 *            What type this reference is.
	 * @param message
	 *            The message applying to this reference.
	 * @param firstStart
	 *            In the from-file, where the reference begins.
	 * @param firstEnd
	 *            In the from-file, where the reference ends.
	 * @param secondStart
	 *            In the to-file, where the reference begins.
	 * @param secondEnd
	 *            In the to-file, where the reference ends.
	 */
	public FileDiff(Type type, String message, Location firstStart,
			Location firstEnd, Location secondStart, Location secondEnd) {
		this(type, message, new LocationRange(firstStart, firstEnd),
				secondStart == null ? null : new LocationRange(secondStart,
						secondEnd));
	}
	 ...
	 *            The message applying to this reference.
	 * @param fromLoc
	 *            The location range in the from-file.
	 * @param toLoc
	 *            The location range in the to-file.
	 */
	public FileDiff(Type type, String message, LocationRange fromLoc,
			LocationRange toLoc) {
		this.type = type;
	 ...
	 */
	public FileDiff(Type type, LocationRange fromLoc, LocationRange toLoc,
			Message msg, Object... params) {
		this.type = type;
	 ...
	 * 
	 * @param obj
	 *            The reference to compare this to.
	...
	public boolean isOnSameLine(LocationRange loc) {
		return getFirstLocation().getStart().getLine() == loc.getStart()
				.getLine();
	}
