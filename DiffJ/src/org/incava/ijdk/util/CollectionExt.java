...
public class CollectionExt {
	 ...
	 */
	public static <Type> Set<Type> intersection(Collection<Type> a,
			Collection<Type> b) {
	 ...
	 */
	public static <Type> boolean hasAll(Collection<Type> src,
			Collection<Type> tgt) {
	 ...
	 * If <code>src</code> or <code>tgt</code> is null, false is returned.
	 */
	public static <Type> boolean hasAny(Collection<Type> src,
			Collection<Type> tgt) {
	 ...
	 */
	private static <Type> boolean checkHas(Collection<Type> src,
			Collection<Type> tgt, boolean forAll) {
