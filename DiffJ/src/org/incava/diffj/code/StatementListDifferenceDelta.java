...
public abstract class StatementListDifferenceDelta extends
		StatementListDifference {
	public StatementListDifferenceDelta(StatementList fromStatements,
			StatementList toStatements, Integer delStart, Integer delEnd,
			Integer addStart, Integer addEnd) {
		super(fromStatements, toStatements, delStart, delEnd, addStart, addEnd);
	}

	public abstract String getMessage(String name);

	public abstract FileDiff getFileDiff(String msg, LocationRange fromLocRg,
			LocationRange toLocRg);
	...
	public void process(String name, StatementList fromStatements,
			StatementList toStatements, Differences differences) {
