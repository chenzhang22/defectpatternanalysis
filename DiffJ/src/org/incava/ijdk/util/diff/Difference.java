...
public class Difference {
	 ...
	 */
	public Difference(Integer delStart, Integer delEnd, Integer addStart,
			Integer addEnd) {
	...
	public String toStringOrig() {
		...
		sb.append("del: [").append(delStart).append(", ").append(delEnd)
				.append(']');
		sb.append(' ');
		sb.append("add: [").append(addStart).append(", ").append(addEnd)
				.append(']');
		sb.append("add: [").append(addStart).append(", ").append(addEnd)
				.append(']');
		return sb.toString();
