...
/**
 * <p>
 * Provides quasi-logging support, more akin to debugging/development output and
 * trace statements than logging per se. Supports both tabular and non-tabular
 * output formats, the former being with the files, line numbers, classes, and
 * methods being arranged so that they line up vertically. That format, I've
 * found, is better for larger projects (500M+ LOC), in which class names and
 * package hierarchies tend to be larger. The non-tabular format seems better
 ...
 * 
 * <p>
 * There is a serious performance hit to using this package, since each output
 * statement results in an exception being created.
 * </p>
 * 
 * <p>
...
public class Log extends Logger {
	 ...
	 */
	public final static EnumSet<ANSIColor> NO_COLORS = EnumSet
			.noneOf(ANSIColor.class);
	...
	public static boolean stack(Level level, EnumSet<ANSIColor> colors,
			Object obj) {
	...
	public static boolean stack(EnumSet<ANSIColor> colors, String name,
			Object obj) {
	...
	public static boolean stack(Level level, ANSIColor color, String name,
			Object obj) {
	...
	public static boolean log(Level level, ANSIColor color, String name,
			Object obj) {
	...
	public static boolean inspect(Level level, EnumSet<ANSIColor> colors,
			Object obj) {
	...
	public static boolean inspect(EnumSet<ANSIColor> colors, String name,
			Object obj) {
	...
	public static boolean inspect(Level level, ANSIColor color, String name,
			Object obj) {
