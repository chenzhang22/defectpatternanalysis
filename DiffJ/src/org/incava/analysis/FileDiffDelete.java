 ...
 * position. Note that code deleted is not the same as a section of code
 * deleted.
 * 
 * @todo fix the names.
 */
public class FileDiffDelete extends FileDiff {
	public FileDiffDelete(String message, LocationRange fromLoc,
			LocationRange toLoc) {
		super(Type.DELETED, message, fromLoc, toLoc);
	}

	public FileDiffDelete(LocationRange fromLoc, LocationRange toLoc,
