...
public class DiffEntity implements Serializable{
	...
	private int inducedStartLineNumber;
	private int inducedStartcolumnNumber;
	private int inducedEndLineNumber;
	private int inducedEndcolumnNumber;
	private int fixedStartLineNumber;
	private int fixedStartcolumnNumber;
	private int fixedEndLineNumber;
	private int fixedEndcolumnNumber;
	...
	public boolean equals(Object obj) {
		...
		DiffEntity other = (DiffEntity) obj;
		if (basicType == null) {
	...
	public String toString() {
		return "DiffEntity [bugId=" + bugId + ", inducedRevisionId="
				+ inducedRevisionId + ", fixedRevisionId=" + fixedRevisionId
				+ ", fileName=" + fileName + ", basicType=" + basicType
				+ ", changeType=" + changeType + ", message=" + message
				+ ", inducedStartLineNumber=" + inducedStartLineNumber
				+ ", inducedStartcolumnNumber=" + inducedStartcolumnNumber
				+ ", inducedEndLineNumber=" + inducedEndLineNumber
				+ ", inducedEndcolumnNumber=" + inducedEndcolumnNumber
				+ ", fixedStartLineNumber=" + fixedStartLineNumber
				+ ", fixedStartcolumnNumber=" + fixedStartcolumnNumber
				+ ", fixedEndLineNumber=" + fixedEndLineNumber
				+ ", fixedEndcolumnNumber=" + fixedEndcolumnNumber + "]";
	}
}
