...
public class ParameterExactNameMatch extends ParameterMatch {
	public ParameterExactNameMatch(ASTFormalParameter fromFormalParam,
	...
	public void diff(Differences differences) {
		...
		differences.changed(fromFormalParam, toFormalParam,
				Parameters.PARAMETER_TYPE_CHANGED, fromType, toType);
	}
}
