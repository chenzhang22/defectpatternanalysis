...
public class TestCtors extends ItemsTest {
	...
	public void testClassConstructorAdded() {
		...
		new FileDiffAdd(locrg(1, 1, 3, 1), locrg(3, 5, 21),
				Ctor.CONSTRUCTOR_ADDED, "Test(String)"));
	}
	...
	public void testClassConstructorRemoved() {
		...
		new FileDiffDelete(locrg(3, 12, 44), locrg(1, 1, 3, 1),
				Ctor.CONSTRUCTOR_REMOVED, "Test(int, double, float)"));
	}
}
