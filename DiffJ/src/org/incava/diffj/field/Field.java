...
public class Field extends AccessibleElement implements Diffable<Field> {
	public static final Message FIELD_REMOVED = new Message(
			"field removed: {0}", ChangeType.FIELD_REMOVED);
	public static final Message FIELD_ADDED = new Message("field added: {0}",
			ChangeType.FIELD_ADDED);
	public final static Messages FIELD_MSGS = new Messages(FIELD_ADDED, null,
			FIELD_REMOVED);
	...
	protected ASTType getType() {
		return SimpleNodeUtil.findChild(field,
				net.sourceforge.pmd.ast.ASTType.class);
	}

	protected Variables getVariables() {
		List<ASTVariableDeclarator> varDecls = SimpleNodeUtil.findChildren(
				field, ASTVariableDeclarator.class);
