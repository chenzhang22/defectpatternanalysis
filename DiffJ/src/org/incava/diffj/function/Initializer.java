...
public class Initializer implements Diffable<Initializer> {
	public static final Message STATIC_BLOCK_REMOVED = new Message(
			"static block removed", ChangeType.STATIC_BLOCK_REMOVED);
	public static final Message STATIC_BLOCK_ADDED = new Message(
			"static block added", ChangeType.STATIC_BLOCK_ADDED);
	public final static Messages STATIC_BLOCK_MSGS = new Messages(
			STATIC_BLOCK_ADDED, null, STATIC_BLOCK_REMOVED);
