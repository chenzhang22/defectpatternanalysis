...
public class LogIterator extends LogCollection {
	public static <T> LogIterator create(Level level, ItemColors colors,
			String name, Iterator<T> it, int numFrames) {
	...
	public <T> LogIterator(Level level, ItemColors colors, String name,
			Iterator<T> it, int numFrames) {
