...
public class BugTrackingConstants {
	...
	public static final String GIT_REPO_PATH = ECLIPSE_UI_GIT_REPO_PATH;
	public static final String HIBERNATE_CONF_PATH = DaoConstants.ECLIPSE_UI_HIBERNATE_LOCATION_PATH;
}
