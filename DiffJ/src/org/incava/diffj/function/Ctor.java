...
public class Ctor extends Function implements Diffable<Ctor> {
	public final static Message CONSTRUCTOR_REMOVED = new Message(
			"constructor removed: {0}", ChangeType.CONSTRUCTOR_REMOVED);
	public final static Message CONSTRUCTOR_ADDED = new Message(
			"constructor added: {0}", ChangeType.CONSTRUCTOR_ADDED);
	public final static Messages CTOR_MESSAGES = new Messages(
			CONSTRUCTOR_ADDED, null, CONSTRUCTOR_REMOVED);
