...
public class JavaElementFactory {
	public JavaFSElement createElement(File file, String label, String source,
			boolean recurseDirectories) throws DiffJException {
	...
	public JavaFile createFile(File file, String label, String source)
			throws DiffJException {
		if (file == null || file.getName().equals("-")
				|| (file.isFile() && verifyExists(file, label))) {
