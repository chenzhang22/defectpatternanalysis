...
public class FileDiffAdd extends FileDiff {
	public FileDiffAdd(String message, LocationRange fromLoc,
			LocationRange toLoc) {
		super(Type.ADDED, message, fromLoc, toLoc);
	}

	public FileDiffAdd(String message, Location fromStart, Location fromEnd,
			Location toStart, Location toEnd) {
		super(Type.ADDED, message, fromStart, fromEnd, toStart, toEnd);
	}

	public FileDiffAdd(LocationRange fromLoc, LocationRange toLoc, Message msg,
			Object... params) {
