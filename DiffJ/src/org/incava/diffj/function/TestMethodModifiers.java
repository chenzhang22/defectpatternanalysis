...
public class TestMethodModifiers extends ItemsTest {
	...
	public void testModifierAdded() {
		...
		new Lines("class Test {", "", "    static void foo() {}", "}"),
	...
	public void testModifierAddedToExisting() {
		evaluate(
				new Lines("class Test {", "    public void foo() {}", "", "}"),

				new Lines("class Test {", "",
						"    static public void foo() {}", "}"),

				makeModifierRef(locrg(2, 5, 10), locrg(3, 5, 10), null,
						"static"));
	}

	public void testModifierRemoved() {
		evaluate(new Lines("class Test {", "    final void foo() {}", "", "}"),
