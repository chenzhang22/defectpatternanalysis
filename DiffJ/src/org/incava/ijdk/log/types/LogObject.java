...
public class LogObject {
	public enum InspectOptionType {
		INCLUDE_SUPERCLASSES, INCLUDE_STATIC
	};
	...
	public static Map<String, Object> inspect(
			EnumSet<InspectOptionType> inspOpts, Object obj) {
		return isNotNull(obj) ? inspectForClass(inspOpts, obj.getClass(), obj)
				: null;
	}

	public static Map<String, Object> inspectFully(Object obj) {
		return inspectFully(EnumSet.of(InspectOptionType.INCLUDE_SUPERCLASSES),
				obj);
	}

	public static Map<String, Object> inspectFully(
			EnumSet<InspectOptionType> inspOpts, Object obj) {
		if (isNull(obj)) {
			return null;
		}
		...
		while (cls != null) {
			...
			cls = inspOpts.contains(InspectOptionType.INCLUDE_SUPERCLASSES) ? cls
					.getSuperclass() : null;
		}
		return attributes;
	}

	public static Map<String, Object> inspectForClass(
			EnumSet<InspectOptionType> inspOpts, Class<?> cls, Object obj) {
		if (isNull(obj)) {
			return null;
		}
	...
	public static void getFieldValue(EnumSet<InspectOptionType> inspOpts,
			Object obj, Field fld, Map<String, Object> attributes) {
		int mods = fld.getModifiers();

		if (Modifier.isStatic(mods)
				&& !inspOpts.contains(InspectOptionType.INCLUDE_STATIC)) {
			return;
		}
