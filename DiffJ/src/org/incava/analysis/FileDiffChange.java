...
public class FileDiffChange extends FileDiff {
	public FileDiffChange(String message, LocationRange fromLoc,
			LocationRange toLoc) {
		super(Type.CHANGED, message, fromLoc, toLoc);
	}

	public FileDiffChange(String message, Location fromStart, Location fromEnd,
			Location toStart, Location toEnd) {
		super(Type.CHANGED, message, fromStart, fromEnd, toStart, toEnd);
	}

	public FileDiffChange(LocationRange fromLoc, LocationRange toLoc,
	 ...
	 */
	public FileDiffChange(String message, FileDiff fileDiff,
			LocationRange fromLocRg, LocationRange toLocRg) {
		this(message, fileDiff.getFirstLocation().getStart(), fromLocRg
				.getEnd(), fileDiff.getSecondLocation().getStart(), toLocRg
				.getEnd());
	}
