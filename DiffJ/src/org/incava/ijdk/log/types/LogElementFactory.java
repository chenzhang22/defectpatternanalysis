...
public class LogElementFactory {
	...
	public static Class<? extends LogElement> findElmtClass(Object obj) {
		...
		for (Map.Entry<Class<?>, Class<? extends LogElement>> entry : clsToElmtClasses
				.entrySet()) {
	...
	public static LogElement createLogElement(
			Class<? extends LogElement> elmtCls, Level level,
			ItemColors colors, String name, Object obj, int numFrames) {
		try {
			Constructor<?> ctor = elmtCls.getConstructor(Level.class,
					ItemColors.class, String.class, Object.class, int.class);
			return (LogElement) ctor.newInstance(level, colors, name, obj,
					numFrames);
		} catch (Exception ex) {
			return null;
		}
	...
	public static LogElement create(Level level, ItemColors colors,
		...
		if (obj == null) {
			...
			if (elmtCls != null) {
				return createLogElement(elmtCls, level, colors, name, obj,
						numFrames);
			}
		}
