...
public class TestParameterTypes extends IncavaTestCase {
	...
	public void assertMatchScore(double expected, List<String> fromParamTypes,
			List<String> toParamTypes) {
		ParameterTypes fpt = new ParameterTypes(fromParamTypes);
		ParameterTypes tpt = new ParameterTypes(toParamTypes);
		assertEquals("fromTypes: " + fromParamTypes + "; toTypes: "
				+ toParamTypes, expected, fpt.getMatchScore(tpt));
	}
	...
	public void testGetMatchScoreThreeTwoCommonOneRepeated() {
		assertMatchScore(2, list("int", "String", "String"),
				list("String", "String", "int"));
	}

	public void testGetMatchScoreThreeAllCommonAllDifferentOrder() {
		assertMatchScore(2, list("int", "String", "byte[]"),
				list("String", "byte[]", "int"));
	}
	...
	public void testGetMatchScoreThreeIncludesTwoMisordered() {
		assertMatchScore(1, list("int", "String"),
				list("String", "int", "double"));
	}

	public void testGetMatchScoreFiveIncludesThreeMisordered() {
		assertMatchScore(1, list("int", "double", "String"),
				list("String", "int", "byte[]", "double", "float"));
	}

	public void testGetMatchScoreFourIncludesThreeMisordered() {
		assertMatchScore(1, list("int", "double", "String"),
				list("String", "int", "byte[]", "double"));
	}
