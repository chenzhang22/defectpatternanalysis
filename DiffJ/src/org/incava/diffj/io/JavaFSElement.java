...
public abstract class JavaFSElement extends File {
	...
	public abstract int compareTo(Report report, JavaFSElement elmt)
			throws DiffJException;

	public abstract int compareFrom(Report report, JavaFile file)
			throws DiffJException;

	public abstract int compareFrom(Report report, JavaDirectory dir)
			throws DiffJException;
}
