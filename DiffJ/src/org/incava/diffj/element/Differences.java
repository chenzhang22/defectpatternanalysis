...
public class Differences {
	...
	public void changed(Token fromStart, Token fromEnd, Token toStart,
			Token toEnd, Message msg, Object... params) {
		add(new FileDiffChange(toRange(fromStart, fromEnd), toRange(toStart,
				toEnd), msg, params));
	}
	...
	public void changed(SimpleNode from, SimpleNode to, Message msg,
			Object... params) {
		changed(from.getFirstToken(), from.getLastToken(), to.getFirstToken(),
				to.getLastToken(), msg, params);
	}

	public void changed(SimpleNode from, Token to, Message msg,
			Object... params) {
		changed(from.getFirstToken(), from.getLastToken(), to, to, msg, params);
	}

	public void changed(Token from, SimpleNode to, Message msg,
			Object... params) {
	...
	public void deleted(Token fromStart, Token fromEnd, Token toStart,
			Token toEnd, Message msg, Object... params) {
		add(new FileDiffDelete(toRange(fromStart, fromEnd), toRange(toStart,
				toEnd), msg, params));
	}
	...
	public void deleted(SimpleNode from, SimpleNode to, Message msg,
			Object... params) {
		deleted(from.getFirstToken(), from.getLastToken(), to.getFirstToken(),
				to.getLastToken(), msg, params);
	}
	...
	public void added(Token fromStart, Token fromEnd, Token toStart,
			Token toEnd, Message msg, Object... params) {
		add(new FileDiffAdd(toRange(fromStart, fromEnd),
				toRange(toStart, toEnd), msg, params));
	}
	...
	public void added(SimpleNode from, SimpleNode to, Message msg,
			Object... params) {
		added(from.getFirstToken(), from.getLastToken(), to.getFirstToken(),
				to.getLastToken(), msg, params);
	}
