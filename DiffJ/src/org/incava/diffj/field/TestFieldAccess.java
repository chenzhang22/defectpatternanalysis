...
public class TestFieldAccess extends ItemsTest {
	...
	public void testAccessChanged() {
		evaluate(new Lines("class Test {", "    private int i;", "", "}"),

		new Lines("class Test {", "", "    public int i;", "}"),
