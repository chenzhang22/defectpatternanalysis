...
public class Logger {
	...
	public static void setMethodColor(String className, String methodName,
			ANSIColor color) {
		writer.setMethodColor(className, methodName, color);
	}
	...
	public static void set(boolean columns, int fileWidth, int lineWidth,
			int classWidth, int funcWidth) {
	...
	public static boolean stack(Level level, EnumSet<ANSIColor> msgColors,
	...
	public static boolean log(Level level, EnumSet<ANSIColor> msgColors,
			String name, Object obj) {
		ItemColors colors = new ItemColors(msgColors);
		return stack(level, colors, name, obj, 1);
	}

	public static boolean stack(Level level, ItemColors colors, String name,
			Object obj, int numFrames) {
		return writer.stack(level, colors, name, obj, numFrames);
	}

	public static boolean inspect(Level level, EnumSet<ANSIColor> msgColors,
			String name, Object obj, int numFrames) {
		ItemColors colors = new ItemColors(msgColors);
		if (isNull(obj)) {
			return stack(level, colors, name, obj, numFrames);
	...
	public static boolean stack(Object obj) {
		return stack(LEVEL5, EnumSet.noneOf(ANSIColor.class), null, obj,
				DEFAULT_STACK_DEPTH);
	}
