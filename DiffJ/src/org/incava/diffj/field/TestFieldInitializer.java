...
import static org.incava.diffj.field.Variable.INITIALIZER_ADDED;
import static org.incava.diffj.field.Variable.INITIALIZER_REMOVED;
...
public class TestFieldInitializer extends ItemsTest {
	...
	public void testInitializerAdded() {
		evaluate(new Lines("class Test {", "    int i;", "", "}"),

		new Lines("class Test {", "", "    int i = 4;", "}"),

				new FileDiffChange(INITIALIZER_ADDED.format(), locrg(2, 9, 9),
						locrg(3, 13, 13)));
	}

	public void testInitializerRemoved() {
		evaluate(new Lines("class Test {", "    int i = 4;", "", "}"),

		new Lines("class Test {", "", "    int i;", "}"),

		new FileDiffChange(INITIALIZER_REMOVED.format(), locrg(2, 13, 13),
				locrg(3, 9, 9)));
	}
	...
	public void testInitializerCodeChanged() {
		evaluate(
				...
				new Lines("class Test {", "", "    int i = 5;", "}"),

				makeCodeChangedRef(CODE_CHANGED, "i", locrg(2, 13, 13),
						locrg(3, 13, 13)));
	}
	...
	public void testInitializerCodeAdded() {
		...
		new Lines("class Test {", "", "    int i = 4 * 5;", "}"),
	...
	public void testInitializerCodeRemoved() {
		evaluate(
				...
				makeCodeDeletedRef(CODE_REMOVED, "i", locrg(2, 15, 17),
						locrg(3, 14, 14)));
	}
}
