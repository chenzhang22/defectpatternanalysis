...
public class ReaderExt {
	 ...
	 * @see ReadOptionType
	 */
	public static List<String> readLines(Reader rdr,
			EnumSet<ReadOptionType> options) {
		try {
			List<String> lines = new ArrayList<String>();
			BufferedReader br = new BufferedReader(rdr);
			boolean checkEmpty = CollectionExt.contains(options,
					ReadOptionType.NONEMPTY);
	...
	public static String readAsString(Reader fr, EnumSet<ReadOptionType> options) {
		...
		boolean addEoln = CollectionExt.contains(options,
				ReadOptionType.ADD_EOLNS);
