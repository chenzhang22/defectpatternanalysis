...
public class Package {
	public static final Message PACKAGE_REMOVED = new Message(
			"package removed: {0}", ChangeType.PACKAGE_REMOVED);
	public static final Message PACKAGE_ADDED = new Message(
			"package added: {0}", ChangeType.PACKAGE_ADDED);
	public static final Message PACKAGE_RENAMED = new Message(
			"package renamed from {0} to {1}", ChangeType.PACKAGE_RENAMED);
	...
	public ASTName getPackageName() {
		return SimpleNodeUtil.findChild(pkg,
