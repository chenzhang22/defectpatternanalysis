...
import static org.incava.ijdk.util.IUtil.iter;
...
public abstract class Item {
	...
	public Item(ANSIColor color, StackElements stackElements, Integer width) {
		this(color == null ? null : new ANSIColorList(color), stackElements,
				width);
	}
	...
	public boolean isRepeated(StackElements stackElements) {
		return stackElements.getPrevious() != null
				&& ObjectExt.areEqual(
						getStackField(stackElements.getPrevious()),
						getStackField(stackElements.getCurrent()));
	}
