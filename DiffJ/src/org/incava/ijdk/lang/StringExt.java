...
public class StringExt {
	 ...
	 * <code>ch</code>'s following the string to a length of <code>length</code>
	 * .
	 * 
	 * Examples: pad("abcd", '*', 8) -> "abcd****" pad("abcd", '*', 3) -> "abcd"
	 */
	 ...
	 *            The source string.
	 * @param index
	 *            The index into the source string. Negative value goes from end
	 *            backward.
	 */
	 ...
	 */
	public static String substring(String str, Integer fromIndex,
			Integer toIndex) {
		if (str == null) {
			return null;
		}
	...
	public static Boolean eqi(String a, String b) {
		return a == null && b == null ? true : a == null ? false
				: b == null ? false : a.equalsIgnoreCase(b);
	}
