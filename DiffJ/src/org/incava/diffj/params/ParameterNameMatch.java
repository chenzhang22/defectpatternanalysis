...
public class ParameterNameMatch extends ParameterMatch {
	public ParameterNameMatch(ASTFormalParameter fromFormalParam, int index,
	...
	public void diff(Differences differences) {
		...
		differences.changed(fromFormalParam, toParam,
				Parameters.PARAMETER_REORDERED, fromNameTk.image, index, toIdx);
	}
}
