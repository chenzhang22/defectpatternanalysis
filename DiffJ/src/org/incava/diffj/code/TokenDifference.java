...
public abstract class TokenDifference extends Difference {
	public TokenDifference(Integer delStart, Integer delEnd, Integer addStart,
			Integer addEnd) {
		super(delStart, delEnd, addStart, addEnd);
	}

	public abstract FileDiff getFileDiff(String str, LocationRange fromLocRg,
			LocationRange toLocRg);

	public abstract Message getMessage();

	public FileDiff execute(String name, LocationRange fromLocRg,
			LocationRange toLocRg, Differences differences) {
