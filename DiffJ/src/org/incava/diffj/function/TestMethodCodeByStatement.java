...
public class TestMethodCodeByStatement extends ItemsTest {
	...
	public List<TokenList> showMethod(String fileName) throws Exception {
		...
		Method meth = new Method(
				(net.sourceforge.pmd.ast.ASTMethodDeclaration) methNode);
	...
	public void testMethod() throws Exception {
		tr.Ace.onBlue("******************************************");
		showMethod("diffj/codecomp/d0/Changed.java");
		showMethod("diffj/codecomp/d1/Changed.java");
		tr.Ace.onBlue("******************************************");
	}
	...
	public void testCtor() throws Exception {
		tr.Ace.onGreen("******************************************");
		showCtor("diffj/codecomp/d0/ChangedCtor.java");
		showCtor("diffj/codecomp/d1/ChangedCtor.java");
		tr.Ace.onGreen("******************************************");
	}
}
